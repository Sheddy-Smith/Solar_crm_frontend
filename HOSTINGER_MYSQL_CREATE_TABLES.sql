...
CREATE TABLE `accounts_module_purchasechallanline` (
  ...
  CONSTRAINT `accounts_module_purchasechallanline_chk_1` CHECK ((`sort_order` >= 0))
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `accounts_module_purchaseinvoiceextracharge` (
  ...
  CONSTRAINT `accounts_module_purchaseinvoiceextracharge_chk_1` CHECK ((`sort_order` >= 0))
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `accounts_module_purchaseinvoiceline` (
  ...
  CONSTRAINT `accounts_module_purchaseinvoiceline_chk_1` CHECK ((`sort_order` >= 0))
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `accounts_module_sellchallanline` (
  ...
  CONSTRAINT `accounts_module_sellchallanline_chk_1` CHECK ((`sort_order` >= 0))
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `accounts_module_sellinvoiceline` (
  ...
  CONSTRAINT `accounts_module_sellinvoiceline_chk_1` CHECK ((`sort_order` >= 0))
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `accounts_user` (
  ...
  CONSTRAINT `mobile_length_or_blank` CHECK (((`mobile` = _utf8mb4'') or regexp_like(`mobile`,_utf8mb4'^\\d{10}$',_utf8mb4'c')))
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `crm_settings_documentnumberseries` (
  ...
  CONSTRAINT `crm_settings_documentnumberseries_chk_1` CHECK ((`next_number` >= 0)),
  CONSTRAINT `crm_settings_documentnumberseries_chk_2` CHECK ((`padding` >= 0))
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `crm_settings_masterrecord` (
  ...
  CONSTRAINT `crm_settings_masterrecord_chk_1` CHECK ((`sort_order` >= 0))
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `crm_settings_paymentmode` (
  ...
  CONSTRAINT `crm_settings_paymentmode_chk_1` CHECK ((`sort_order` >= 0))
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `leads_quotation` (
  ...
  CONSTRAINT `leads_quotation_chk_1` CHECK ((`inverter_quantity` >= 0)),
  CONSTRAINT `leads_quotation_chk_2` CHECK ((`number_of_panels` >= 0))
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `leads_quotationitem` (
  ...
  CONSTRAINT `quantity_numeric` CHECK (regexp_like(`quantity`,_utf8mb4'^\\d+(\\.\\d+)?$',_utf8mb4'c')),
